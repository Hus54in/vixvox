      ...
      child: Column(
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream: widget.comment.reference.collection('replies').orderBy('dateCreated', descending: true).snapshots(),
            builder: (context, snapshot) {
              ...
              return Column(
                ...
                children: replies.map((reply) {
                  return Padding(
                    padding: const EdgeInsets.only(left: 16.0, top: 4.0, bottom: 4.0), // Adjusted padding
                    child: CommentItem(
                      comment: reply,
